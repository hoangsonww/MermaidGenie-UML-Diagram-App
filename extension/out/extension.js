...
class MermaidGenieSidebarProvider {
...
MermaidGenieSidebarProvider.viewType = "mermaidgenieViewer.sidebar";
function getSettings() {
  const cfg = vscode.workspace.getConfiguration("mermaidgenieViewer");
  return {
    panelTitle: cfg.get("panelTitle", "MermaidGenie"),
    viewColumn: cfg.get("viewColumn", 1),
    retainContext: cfg.get("retainContext", true),
    enableScripts: cfg.get("enableScripts", true),
    iframeWidth: cfg.get("iframeWidth", "100%"),
    iframeHeight: cfg.get("iframeHeight", "100%"),
  };
}
function getNonce() {
  let text = "";
