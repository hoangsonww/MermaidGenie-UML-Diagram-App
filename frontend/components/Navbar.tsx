...
import { LogOut, Moon, Sun, Monitor, PanelLeft, UserRound } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-card/80 backdrop-blur supports-[backdrop-filter]:bg-card/60 border-b">
      <nav className="flex items-center justify-between w-full px-6 py-3 max-w-7xl mx-auto">
        <Link
          href="/"
